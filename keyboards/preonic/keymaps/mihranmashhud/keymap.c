 ...
 * |------|------|------|------|------|------|------|------|------|------|------|------|
 * | LCtrl| RCtrl| Alt  |Super |Lower |Space  Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_CAPS, _______, _______, _______, _______, ALL_GG , _______, _______, _______, _______, _______, _______,
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, KC_MINS, KC_PLUS, _______, _______, KC_UNDS, KC_EQL , _______, _______, _______,
  KC_CAPS, _______, KC_LBRC, KC_LCBR, KC_LPRN, KC_LT  , KC_GT  , KC_RPRN, KC_RCBR, KC_RBRC, KC_COLN, KC_PIPE,
...
[_MOUSE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, _______, TG(_MOUSE), KC_WH_L, KC_WH_R, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______   , _______, _______, _______, _______, _______
),
